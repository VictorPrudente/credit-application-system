...
class CustomerControllerTest {
    ...
    fun `should create a customer and return 201 status`() {
        ...
        mockMvc.perform(
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.lastName").value("Subject"))
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.street").value("Test Street, 404"))
    ...
    fun `should not find customer with invalid id and return 400 status`() {
        ...
        mockMvc.perform(
            ...
            .andExpect(
                MockMvcResultMatchers.jsonPath("$.exception")
                    .value("class com.creditter.credit.application.system.exceptions.CustomException")
            )
            .andExpect(MockMvcResultMatchers.jsonPath("$.details[*]").isNotEmpty)
            .andDo(MockMvcResultHandlers.print())
    }
    ...
    fun `should update a customer and return 200 status`() {
        ...
        mockMvc.perform(
            ...
            .andExpect(MockMvcResultMatchers.status().isOk)
            .andExpect(MockMvcResultMatchers.jsonPath("$.firstName").value("TestUpdated"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.lastName").value("SubjectUpdated"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.cpf").value("28475934625"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.email").value("test@email.com"))
    ...
    private fun builderCustomerUpdateDto(
        firstName: String = "TestUpdated",
        lastName: String = "SubjectUpdated",
